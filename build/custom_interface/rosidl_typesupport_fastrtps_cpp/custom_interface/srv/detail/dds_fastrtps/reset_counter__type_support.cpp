...
#include "custom_interface/srv/detail/reset_counter__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interface::srv::ResetCounter_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::srv::ResetCounter_Request & ros_message)
{
  // Member: reset_value
  cdr >> ros_message.reset_value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interface::srv::ResetCounter_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::srv::ResetCounter_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interface::srv::ResetCounter_Request *>(
    untyped_ros_message);
...
{
  return &custom_interface::srv::typesupport_fastrtps_cpp::_ResetCounter_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, srv, ResetCounter_Request)() {
  return &custom_interface::srv::typesupport_fastrtps_cpp::_ResetCounter_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interface
cdr_serialize(
  const custom_interface::srv::ResetCounter_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::srv::ResetCounter_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::srv::ResetCounter_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::srv::ResetCounter_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::srv::ResetCounter_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::srv::typesupport_fastrtps_cpp::_ResetCounter_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, srv, ResetCounter_Response)() {
  return &custom_interface::srv::typesupport_fastrtps_cpp::_ResetCounter_Response__handle;
}
...
{
  return &custom_interface::srv::typesupport_fastrtps_cpp::_ResetCounter__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, srv, ResetCounter)() {
  return &custom_interface::srv::typesupport_fastrtps_cpp::_ResetCounter__handle;
}
