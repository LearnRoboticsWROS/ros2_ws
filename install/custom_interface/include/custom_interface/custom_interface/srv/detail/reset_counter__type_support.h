...
#ifndef CUSTOM_INTERFACE__SRV__DETAIL__RESET_COUNTER__TYPE_SUPPORT_H_
#define CUSTOM_INTERFACE__SRV__DETAIL__RESET_COUNTER__TYPE_SUPPORT_H_
...
#endif  // CUSTOM_INTERFACE__SRV__DETAIL__RESET_COUNTER__TYPE_SUPPORT_H_
